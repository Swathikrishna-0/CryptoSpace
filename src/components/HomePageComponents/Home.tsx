...
const HomeComnponent = () => {
    ...
    interface MyDrawerContentProps extends DrawerProps {
        children: React.ReactNode;
      }
      

    const MyDrawerContent: React.FC<MyDrawerContentProps> = ({ children, ...props }) => {
    ...
    return (
        ...
        <div>
            ...
            <div className={"flex flex-wrap items-center justify-around"}>
                ...
                { /* FLTER TABS */}
                <div className='flex gap-8 flex-wrap ml-2 md:justify-center justify-around mt-5 md:mt-0'>
                                ...
                                <tr key={coin.id}>
                                    ...
                                    <td className='py-6 cursor-pointer'>
                                        ...
                                        <Image
                                            src={coin.image}
                                            alt="ada"
                                            width={36} // Equivalent to w-9 (9 * 4)
                                            height={36} // Equivalent to h-9 (9 * 4)
                                            className="rounded-full" // Add any additional classes if needed
      />
                                            ...
                                            {reduxFavouritesARR.length === 0 ? <p> Nothing Here Yet </p> :
                                                <>
                                                    ...
                                                    <Image
                                                                    src={item.image}
                                                                    alt='ada'
                                                                    width={48} // Equivalent to w-12 (12 * 4)
